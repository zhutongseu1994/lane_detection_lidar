...
#define MY_DBSCAN_TYPE 3
    ...
    public:
        int cluster_model;
        string sub_ground;
        string sub_no_ground;
        string pub_obst_set;
        string eucliden_param;
        string dbscan_param;

    public:
        string pub_neareast_points;
        float ray_angle_for_lane_detection;
        float lane_region_miny;
        float lane_region_maxy;
        float lane_region_size;
        double lane_clip_height;
    };
} // namespace skywell
