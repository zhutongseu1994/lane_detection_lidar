...
class Param
{
	...
	public:
		string server_ip;
		int server_port;
		string sub_vehicle_state;
		string sub_obst_set;
		string pub_track_set;
		string pub_bounding_boxs;
		string domain_control_serverip;
		int domain_control_serverport;
		std::string interactive_interface_protocol;
