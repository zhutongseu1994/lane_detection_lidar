...
// 条件滤波
	class ConditionFilter
	{
		...
		public:
			...
			// 过滤
			void filter(const CloudT::Ptr source, CloudT::Ptr destination);
			void init();
		private:
	...
	class CropBoxFilter
	{
		...
		public:
			...
			void setNegative(bool negative = false);
			void filter(const CloudT::Ptr source, CloudT::Ptr destination);
			void filter(const CloudT::Ptr source, std::vector<int> &indice);
		private:
			pcl::CropBox<PointT> m_clipper;
	...
	class ExtractIndices
	{
		public:
			...
			void setNegative(bool negative = false);
			void filter(const CloudT::Ptr source,boost::shared_ptr <std::vector<int>> indexPtr,CloudT::Ptr destination);
		private:
